...
function Gallery() {
  return (
    <div>
        <h2 className='mt-16 text-blue-600 p-6	text-6xl font-bold sm:text-center sm:text-5xl xl:text-start xl:text-6xl'>Our Gallery</h2>
        <section className='grid grid-cols-3 gap-9 p-8  sm:grid-cols-1 sm:p-10 lg:grid-cols-2 xl:grid-cols-3'>
